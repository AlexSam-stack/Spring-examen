package com.codigo.cowork_api.model;
...
public class Reserva {
    Long id;
    Long salaId; // FK lógica a Sala
    String responsable; // nombre de quien reserva
    String email; // correo de contacto
    LocalDate fecha; // día de la reserva
    LocalTime horaInicio; // hora de inicio
    LocalTime horaFin; // hora de fin
    String estado; // PENDIENTE | CONFIRMADA | CANCELADA
    String passwordInterno; // dato sensible: NO debe salir en respuestas
